    ...
    return Scaffold(
        ...
        body: ListView(
          children: [
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ProductDetails(
                                    name: Util.name[tappedIndex],
                                    price: Util.price[tappedIndex],
                                    qty: Util.qty[tappedIndex],
                                    discount: Util.discount[tappedIndex],
                                    des: Util.des[tappedIndex],
                                    index: tappedIndex,
                                  )),
                        );
                      });
                      ...
                      child: Card(
                        shape: tappedIndex == index
                            ? new RoundedRectangleBorder(
                                side: new BorderSide(
                                    color: Color(0xff2879FF), width: 1.0),
            ...
            Padding(
              padding: EdgeInsets.only(left: 70.w, right: 70.w, top: 20.h),
              child: InkWell(
                onTap: () async {
                  Navigator.push(
                    context,

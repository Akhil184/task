...
class AddProduct extends StatefulWidget {
  ...
  AddProduct({Key? key,required this.name,required this.price,required this.discount,required this.qty,required this.des,required this.index}) : super(key: key,);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        InkWell(
                          onTap: () async{
                              if(_controller.text.length>0 && _controller1.text.length>0 && _controller2.text.length>0 && _controller3.text.length>0  && _controller4.text.length>0 && widget.index==-1){
                              ...
                              else if(_controller.text.length>0 && _controller1.text.length>0 && _controller2.text.length>0 && _controller3.text.length>0  && _controller4.text.length>0 && widget.index!=-1){
